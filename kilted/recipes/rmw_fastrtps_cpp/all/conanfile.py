...
class RosPackageConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "rmw_dds_common/5.0.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rmw_fastrtps_shared_cpp/9.3.4@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rosidl_dynamic_typesupport/0.3.1@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rosidl_dynamic_typesupport_fastrtps/0.4.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "rosidl_runtime_cpp/4.9.6@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )

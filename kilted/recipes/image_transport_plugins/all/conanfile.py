...
class RosPackageConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "compressed_depth_image_transport/5.1.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "compressed_image_transport/5.1.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "theora_image_transport/5.1.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "zstd_image_transport/5.1.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )

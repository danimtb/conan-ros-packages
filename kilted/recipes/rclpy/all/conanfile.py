...
class RosPackageConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "typing_extensions/4.12.2@ros-kilted",
            run=True,
        )
        self.requires(
            "pyyaml/6.0.2@ros-kilted",
            run=True,
        )
        self.requires(
        ...
        self.requires(
            "rcl_lifecycle/10.1.4@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rcl_logging_interface/3.2.4@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rcl_yaml_param_parser/10.1.4@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "rmw_implementation/3.0.7@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "service_msgs/2.3.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "type_description_interfaces/2.3.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "unique_identifier_msgs/2.7.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )

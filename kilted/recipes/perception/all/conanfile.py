...
class RosPackageConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "image_common/6.1.4@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "image_pipeline/6.0.12@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "image_transport_plugins/5.1.2@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "laser_filters/2.2.3@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "perception_pcl/2.8.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "vision_opencv/4.1.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )

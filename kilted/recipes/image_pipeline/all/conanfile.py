...
class RosPackageConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "depth_image_proc/6.0.12@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "image_publisher/6.0.12@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "image_rotate/6.0.12@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "image_view/6.0.12@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "stereo_image_proc/6.0.12@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )

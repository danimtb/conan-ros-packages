...
class RosPackageConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "keyboard_handler/0.4.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        ...
        self.requires(
            "rosbag2_compression/0.32.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rosbag2_cpp/0.32.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rosbag2_interfaces/0.32.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
        self.requires(
            "rosbag2_storage/0.32.0@ros-kilted",
            transitive_headers=True,
            transitive_libs=True,
            run=True,
        )
